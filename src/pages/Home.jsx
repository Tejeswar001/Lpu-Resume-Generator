...
function Home() {
    return (
        <div className="bg-base-200">
            <section className="relative flex min-h-screen items-center overflow-hidden px-4 pb-10 pt-24">
                ...
                <div className="relative mx-auto flex w-[min(1240px,96%)] flex-col items-center text-center">
                    <div className="max-w-4xl">
                        <h1 className="text-5xl font-black leading-[1.03] text-primary sm:text-6xl xl:text-7xl">
                            Build A Strong Resume,
                            <br />
                            Get Interview Ready
                        </h1>
                        <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-base-content/75 sm:text-xl">
